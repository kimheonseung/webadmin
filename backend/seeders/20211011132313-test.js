  ...
  up: async (queryInterface, Sequelize) => {
    ...
    */
    ...
    await queryInterface.bulkInsert('DEPARTMENT', [
      ...
      {
        id: 5,
        code: 'DEP0000000000004',
        name: '1-1팀',
        upper_department_code: 'DEP0000000000001',
        depth: 2,
        description: '1연구소 1팀',
      },
      {
        id: 6,
        code: 'DEP0000000000005',
        name: '1-2팀',
        upper_department_code: 'DEP0000000000001',
        depth: 2,
        description: '1연구소 2팀',
      ...
      {
        id: 8,
        code: 'DEP0000000000007',
        name: '2-1팀',
        upper_department_code: 'DEP0000000000002',
        depth: 2,
        description: '2연구소 1팀',
      },
      {
        id: 9,
        code: 'DEP0000000000008',
        name: '3-1팀',
        upper_department_code: 'DEP0000000000003',
        depth: 2,
        description: '3연구소 1팀',
      },
      {
        id: 10,
        code: 'DEP0000000000009',
        name: '3-2팀',
        upper_department_code: 'DEP0000000000003',
        depth: 2,
        description: '3연구소 2팀',
